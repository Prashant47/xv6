...
ULIB = pow.o ulib.o usys.o printf.o umalloc.o libfile.o\
       liblog.o exp.o\
...
fs.img: mkfs a test1 $(UPROGS)
	./mkfs fs.img a test1 $(UPROGS)
...
EXTRA=\
	...
	printf.c umalloc.c  \
	README picoc dot-bochsrc *.pl toc.* runoff runoff1 runoff.list\
